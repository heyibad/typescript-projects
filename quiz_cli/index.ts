...
const delayBySeconds = async (ms: number = 2500) => {
...
if (score === questions.length) {
  console.log(
    chalk.bgMagentaBright(
      `Congratulations ${name}! You got all the questions right! 🎉🎉🎉`
    )
  );
} else {
  console.log(
    chalk.greenBright(`${name} your total score is ${score} / 10 🚀`)
  );
}
